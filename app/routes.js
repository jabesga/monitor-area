...
var camp_auth = require('./camp_auth');
...
module.exports = function(app, passport){
    ...
    */
    ...
    // Users
    app.get('/users', camp_auth.isLoggedIn, function(req, res, next) { // check if it is logged
    ...
    // Add teachers
    app.post('/users', camp_auth.isLoggedIn, function(req, res, next) { // check if it is logged
            ...
            teacher.save(function(err, saved){
                if(err){
                    ...
                    if(req.body['notify']){
                        ...
                        require('mail').send_mail(mailOptions);
                    }
